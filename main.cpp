...
int main() {
    ...
    std::cout << "Function calls: " << result.function_probes << std::endl;
    ...
    std::cout << "Problem: min(x^2+y^2) with x+y>=1, x>=0.5" << std::endl;
    ...
    std::cout << "Problem: min((x-3)^2+(y-2)^2) with x+y<=2, x=y" << std::endl;
    ...
    std::cout << "Point: (" << result.result[0] << ", " << result.result[1] << ")" << std::endl;
    std::cout << "Value: " << result.function_value  << std::endl;
    std::cout << "Iterations: " << result.iterations << std::endl;
    std::cout << "Function calls: " << result.function_probes << std::endl;
